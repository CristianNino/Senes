...
class registrousuario : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        references = FirebaseDatabase.getInstance().getReference("usuarios")
    ...
    private fun RegistrarUsuario() {
        ...
        firebaseAuth.createUserWithEmailAndPassword(Rcorreo, Rcontraseña)
            ...
            .addOnFailureListener { e->
                Toast.makeText(this, "Fallo el registro debibo a ${e.message}", Toast.LENGTH_SHORT).show()
            }
    }
    ...
    private fun insertarInfoBD() {
        ...
        references.child(uidBD!!)
            ...
            .addOnFailureListener {e->
                progressDialog.dismiss()
                Toast.makeText(this, "Fallo el registro en BD debibo a ${e.message}", Toast.LENGTH_SHORT).show()
